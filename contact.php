  ...
  <body>
    ...
    <div class="specialDiv sectionTwoBackground">
      ...
      >
        ...
        <div class="mb-3">
          <label for="workInput" class="form-label">Link to your work :</label>
          <input
            type="text"
        ...
        <div class="mb-3">
          <label for="descriptionOfWork" class="form-label"
        ...
        <div class="row">
          <div class="mb-3 col">
            <label for="formFile" class="form-label"
              >Profile picture you would like used</label
            >
            <input class="form-control" type="file" id="formFile" />
          </div>
          <div class="mb-3 col">
            <label for="creatorBio" class="form-label"
        ...
        <button class="btn btn-dark button" id="submitButton" type="submit">
          Submit form
        </button>
        <br />
      </form>
